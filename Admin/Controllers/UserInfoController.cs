...
namespace Admin.Controllers
{
    public class UserInfoController : Controller
    {
        ...
        /// 在这里也需要依赖接口编程，用户接口
        /// </summary>
        private readonly IbaseuserService _userInfoService = new baseuserService();

        /// <summary>
        /// 依赖接口编程，角色接口信息
        /// </summary>
        private readonly IbaseroleService _roleInfoService = new baseroleService();
        ...
        public ActionResult SetRole(int ID)
        {
            ...
            {
                var dd = (from r in currentSetRoleUser.r_user_role
                          //当前用户和角色中间表的集合数据
