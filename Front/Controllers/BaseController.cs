...
namespace Front.Controllers
{
    ...
    {
        public IborrowingproductService _borrowingproductService = new borrowingproductService();
        public IfinanceproductService _financeproductService = new financeproductService();
